...
RSpec.describe ShopController, type: :controller do
  ...
  let!(:product1_packaged) { create(:inventory_item, :packaged, product: product1, quantity: 1.0, lot_number: "SHOP-CTRL-LOT-1") }
  let!(:product2_packaged) { create(:inventory_item, :packaged, product: product2, quantity: 1.0, lot_number: "SHOP-CTRL-LOT-2") }
